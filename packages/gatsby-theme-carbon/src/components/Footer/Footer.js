...
Footer.defaultProps = {
  links: {
    firstCol: [
      ...
      { href: 'https://www.github.com/freight-trust', linkText: 'GitHub' },
      {
        href: 'https://www.freighttrust.com/design',
        linkText: 'Column',
      },
    ...
    secondCol: [
      {
        href: 'https://www.ft-docs.netlify.app',
      ...
      {
        href: 'https://www.freighttrust.com/contact',
        linkText: 'Contact',
      },
    ],
  },
